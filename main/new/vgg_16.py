...
# First, let's create models/vgg16.py:
...
class VGG16Base:
    ...
    def get_all_layers(self):
        """Return list of all layer activations"""
        return [
    ...
    def get_attention_placeholders(self):
        """Return list of all attention placeholders"""
        return [
            self.a11, self.a12,
            self.a21, self.a22,
    ...
    def fc_layers(self):
        """Create the fully connected layers of the VGG16 network"""
        # fc1
